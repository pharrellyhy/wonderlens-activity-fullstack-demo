...
**Key guidance:**
- The demo riddle should be obviously solvable — the goal is to show how the game works, not to challenge.
- Clues should be sensory and concrete (shape, color, sound, feel) — not abstract.
- Show enthusiasm when revealing the answer to model that guessing is fun, even if you already know.
